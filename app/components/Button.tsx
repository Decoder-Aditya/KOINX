...
const Button: React.FC<NextButtonProps> = ({ text, arrow, onClick }) => {
  return (
    <button
      className="w-auto flex items-center bg-white font-medium py-3 px-6 rounded-lg shadow-md m-1 ml-0"
      onClick={onClick} // Attaching onClick function to the button
    >
